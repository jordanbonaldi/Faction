...
public enum NPC {
	...
	Armes("Armes", VillagerType.ARMES, Profession.LIBRARIAN, "world", 317.5, 87, -160.5),
	Classes("Rangs", VillagerType.Classes, Profession.BLACKSMITH, "world", 1243.513, 0, -304.516),
	Divers("Divers", VillagerType.Divers, Profession.PRIEST, "world", 306.5, 87, -151.5),
	Mineur("Mineur", VillagerType.Miner, Profession.BLACKSMITH, "world", 317.5, 87, -152.5),
	Nourriture("Nourriture", VillagerType.FOOD, Profession.BLACKSMITH, "world", 305.5, 87, -160.5),
	Potion("Potions", VillagerType.Potion, Profession.FARMER, "world", 1227.496, 0, -250.306),
	RankCap("Capitaine", VillagerType.Ranks, Profession.FARMER, "world", 1187.496, 0, -284.507),
	RankCol("Colonel", VillagerType.Ranks, Profession.FARMER, "world", 1180.496, 0, -317.507),
	RankCom("Commandant", VillagerType.Ranks, Profession.FARMER, "world", 1181.5, 0, -290.507),
	RankG("Général", VillagerType.Ranks, Profession.FARMER, "world", 1186.496, 0, -323.507),
	RankLt("Lieutenant", VillagerType.Ranks, Profession.FARMER, "world", 1214.496, 0, -285.507),
	RankMar("Maréchal", VillagerType.Ranks, Profession.FARMER, "world", 1213.496, 0, -324.507),
	RankMj("Major", VillagerType.Ranks, Profession.FARMER, "world", 1220.496, 0, -291.507);
