...
public class DataReader {
	...
	public int getAchievements() {
		return this.configfile.getInt("achivements");
	}
	...
	public RankAPI getRank() {
		return API.getInstance().getRank(this.configfile.getString(this.p + ".rank"));
	}
	...
	public void setAchivement(final int i) {
		this.configfile.set("achivements", i);
	}
